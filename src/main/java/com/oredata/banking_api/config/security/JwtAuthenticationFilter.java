...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private final UserDetailsService userDetailsService; // Bu servisi sonraki adımda tanımlayacağız
    ...
    protected void doFilterInternal(
        ...
        final String jwt;
        final String userEmail; // Bizde username ama değişken adı userEmail kalabilir
