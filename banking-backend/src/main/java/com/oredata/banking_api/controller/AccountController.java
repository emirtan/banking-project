...
import com.oredata.banking_api.dto.responseDto.AccountResponseDto; // New DTO
import com.oredata.banking_api.model.entity.Account;
import com.oredata.banking_api.mapper.AccountMapper; // New Mapper
...
public class AccountController {
    ...
    // 2. Search Accounts (With Query Param)
    @GetMapping("/search")
